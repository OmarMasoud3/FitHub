...
# ADMIN DECORATOR ENSURES ONLY ADMIN CAN ADD, EDIT and DELETE POSTS
...
def contact():
    ...
    if contact_form.validate_on_submit():
        ...
        connection = smtplib.SMTP('smtp.gmail.com', 587)  # Gmail SMTP server and port
        connection.starttls()
        connection.login(MY_EMAIL, MY_PASSWORD)
        connection.sendmail(
            from_addr=MY_EMAIL,
            to_addrs=MY_EMAIL,
            msg=f"Subject:You recieved a message from your fitness blog\n\n Name:{name} \n Email: {email}"
